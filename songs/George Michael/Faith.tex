...
Well it ^{C#m}takes a strong man baby but I'm ^{F#7}showing you ^{-}the door ^{N.C.}
\end{prechorus}
...
Be^{E}fore you throw my heart back on the fl^{B}oor \\
Oh baby I ^{E}reconsider my ^*{B}fool ^{-}ish ^{G#m}notion \\
Well I ^{C#m}need someone to hold me but I'll ^{F#7}wait for some^{-}thing more ^{N.C.}
\end{prechorus}
...
\begin{info}\instruction{Repeat second Prechorus end with an extra 8 beat rest}
\end{info}
