...
\AddToShipoutPictureFG{
  \AtPageUpperLeft{%
    \raisebox{-10em}{%
      \hspace{43em}
      \origchord{3}{x,p2,p1,p2,p3,x}{_{D7#9}}%
      \origchord{3}{x,p2,p1,p2,p1,x}{_{D7b9}}%
      \origchord{t}{x,p2,p3,p2,p1,p1}{_{F/B}}%
    }%
  }%
}
...
^{Fmaj7}All you touch and all you see, is ^{G}all your ^{-}life will ^{D7#9*}ever ^{D7b9*}be
\end{chorus}
...
^{Fmaj7}And balanced on the biggest wave, you ^{G}race to-w^{-}ards an ^{D7#9*}early ^{D7b9*}grave
\end{chorus}
...
^{Fmaj7}Calls the faithful to their knees, to ^{G}hear ^{-}the softly ^{D7#9*}spoken ^{D7b9*}magic ^{Bm}spell
\end{chorus}
